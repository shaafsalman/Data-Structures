...
void StudentDatabase::read_csv(const string &filename) {
    ...
    while (getline(file, line)) {
        ...
        addStudent(student);  // Add student to the database
    }

    // Count the total number of students by traversing the trees
    int totalStudentCount = 0;

    // Traverse all batches and schools in LUMS
    ...
    cout << "Total students in the database: " << totalStudentCount << endl;  // Display total student count
