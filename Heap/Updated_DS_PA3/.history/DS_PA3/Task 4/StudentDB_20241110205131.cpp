...
StudentDatabase::StudentDatabase()
    : LUMS(make_shared<node<int, vector<Tree<int, Student>>>>(0, vector<Tree<int, Student>>(4))) {
    // Initialize LUMS with four school trees (one for each school)
    
    for (int i = 0; i < 4; i++) {
        this->LUMS->value[i] = Tree<int, Student>(make_shared<node<int, Student>>(0, Student()));
    }
