...
public:
    ...
    void inOrderHelper(shared_ptr<node<T, S, C>> node, vector<T>& result, int maxShortlist);
    void calculateGenderCount(shared_ptr<node<T, S, C>> node, int& females, int& males);
