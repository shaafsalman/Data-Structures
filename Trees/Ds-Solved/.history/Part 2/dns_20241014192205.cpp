...
int main() {
    DNS dns;
    dns.addWebpage("oxford.org/donate");
    dns.addWebpage("google.com/maps");
    dns.addWebpage("google.com/drive/create");
    dns.addWebpage("rizq.org/users/login");
    dns.addWebpage("google.com/drive/upload");

    // Example usage
    vector<shared_ptr<Webpage>> allOrgWebpages = dns.getAllWebpages("org");
    dns.generateOutput(allOrgWebpages);
