...
//------------------------
// Total Number of Applicants to Shortlist
//------------------------
...
//------------------------
// Shortlisted Candidates on the Right-Most Path
//------------------------
template <class T, class S, class C>
...
//------------------------
// Level-Order Traversal with Limit
//------------------------
template <class T, class S, class C>
...
//------------------------
// Calculate Bias
// Ratios of males to females and their significance in identifying potential bias.
// The ratios represent the proportion of males to females in the left subtree of each node.
// A significant discrepancy in these ratios, especially if accompanied by differing average work experiences, 
// may indicate a bias in the hiring or evaluation process reflected in the tree structure.
//------------------------
template <class T, class S, class C>
