...
void test_num_to_shortlist(shared_ptr<AVL<int, string, string>> tree)
{
	...
	// Debug output for left subtree case
	cout << "Debug: Number to shortlist after adding left node: " << num << endl;
...
void test_bias(shared_ptr<AVL<int, string, string>> tree)
{
	...
	// Debug output for bias comparison
	cout << "Debug: Expected bias ratios: ";
	for (auto val : test_vector) {
		cout << val << " ";
	}
	cout << endl;

	cout << "Debug: Actual bias ratios: ";
	for (auto val : solution_vector) {
		cout << val << " ";
	}
	cout << endl;
	...
	if (test_vector == solution_vector)
	{
		cout << "   Bias test ... \033[32m Passed\033[0m" << endl;
		total_marks += 4;
	}
	else
	{
		cout << "   Bias test ... \033[31m Failed\033[0m" << endl;
	}
