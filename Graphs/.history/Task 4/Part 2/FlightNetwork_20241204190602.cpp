...
Flight::Flight(string flightNumber, shared_ptr<Airport> departureAirport, shared_ptr<Airport> destinationAirport, int distance, int cost, FlightStatus status)
    ...
    if (departureAirport) {
        std::cout << "Adding flight " << flightNumber << " to departure airport " << departureAirport->getAirportCode() << std::endl;
    ...
    if (destinationAirport) {
        std::cout << "Adding flight " << flightNumber << " to destination airport " << destinationAirport->getAirportCode() << std::endl;
...
void Airport::TakeOff(string flightNumber) {
    ...
    std::cout << "Error: Flight " << flightNumber << " not found for takeoff." << std::endl;
}
