...
vector<vector<shared_ptr<Human>>> SocialNetwork::getGroups() {
    ...
    // Ensure 'humans' is properly declared and accessible.
    // If 'humans' is a member variable, make sure it is correctly initialized.
    ...
    for (auto& component : connectedComponents) {
        ...
        for (auto& vertex : component) {
            group.push_back(vertex->getData());  // Get shared_ptr<Human> from Vertex
        }
