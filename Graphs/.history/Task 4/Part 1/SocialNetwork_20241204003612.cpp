...
void Human::removeFriend(shared_ptr<Human> Friend) {
    ...
    // Manually refresh the adjacency list and update the graph structure
    this->Friends.updateAdjacencyMatrix();
    this->Friends.updateAdjacencyList(); // Ensure the adjacency list is updated
